    ...
    <i-article>
        <article>
            ...
            <Demo title="Offset">
                <div slot="demo">
                    <Affix :offset-top="50">
                        <span class="demo-affix">Fixed at 50px to the top</span>
                    </Affix>
                </div>
                <div slot="desc">
            ...
            <Demo title="Fixed at the bottom">
                <div slot="demo">
                    <Affix :offset-bottom="20">
                        <span class="demo-affix">Fixed at 20px to the bottom</span>
                    </Affix>
                </div>
                <div slot="desc">
            ...
            <Demo title="Callback when affix state is changed">
                <div slot="demo">
                    <Affix :offset-top="100" @on-change="change">
                        <span class="demo-affix">Fixed at 100px to the top</span>
                    </Affix>
                </div>
                <div slot="desc">
...
<script>
    ...
    export default {
        ...
        methods: {
            change (status) {
                this.$Message.info(`Current State：${status}`);
            }
        }
    }
</script>