    ...
    <i-article>
        <article>
            ...
            <Demo title="表单控件">
                ...
                <div slot="desc">
                    <p>在 <code>i-form</code> 内，每个表单域由 <code>Form-item</code> 组成，可包含的控件有：Input、Radio、Checkbox、Switch、Select、Slider、DatePicker、TimePicker、Cascader、Transfer、InputNumber、Rate、Upload。</p>
                    <p>给 <code>Form-item</code> 设置属性 <code>label</code> 可以显示表单域的标签，需要给 i-form 设置 <code>label-width</code>。</p>
                </div>
            ...
            <div class="api">
                ...
                <Anchor title="iForm props" h3></Anchor>
                <table>
                    <thead>
                        <tr>
                            <th>属性</th>
                ...
                <Anchor title="iForm methods" h3></Anchor>
                <table>
                    <thead>
                        <tr>
                            <th>方法名</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>validateField</td>
                            <td>对部分表单字段进行校验的方法，参数1为需校验的 prop，参数2为检验完回调，同上</td>
                            <td>callback</td>
                        </tr>
                        <tr>
                            <td>resetFields</td>
